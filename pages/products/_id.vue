			...
			<div class="col-12 mb-3">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<div
								class="image border border-secondary text-center mb-3"
							>
								<img
							...
							<div class="image-2">
								<img
									class="border border-secondary text-center m-1"
									:src="product.image_link"
									alt=""
						...
						<div class="col-md-6">
							<div class="title">
								...
								<h4>₱ {{ addCommaAndTwoDecimalPlaces(product.price) }} / {{ product.unit }}</h4>
								<h6>
