                ...
                <form>
                  <div class="form-group mb-3">
                    <div class="row">
                      <div class="col-lg-3">
                        ...
                        <br>
                        <img :src="preview" alt="" width="200" height="150">
                        <br>
                        <!-- <input type="text" class="form-control" placeholder="ex. Air Jordan"> -->
                        <button type="button" class="btn btn-primary mt-2" style="width:200px;"  @click="$refs.image_file_input.click()">Add Image</button>
                         <input
                    type="file"
                  ...
                  <div class="form-group mb-3">
                    ...
                    <select v-model="form.category_id" name="" id="" class="form-control">
                      ...
                      <option v-for="(item, index) in categories" :value="item.id" :key="index">{{item.category_name}}
                      </option>
                    </select>
                  </div>
                  <div class="form-group mb-3">
                    <button @click="addNewProduct()" type="button" class="btn btn-primary w-25">Save</button>
